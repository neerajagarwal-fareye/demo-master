...
public class MTestCase2 {
    ...
    public void tearUp(String browser, String mode) {
        //driver = Setup.LaunchBrowser(System.getProperty("browser"), System.getProperty("executionMode"));
...
//        System.out.println("UserName--------------------------@@@@@"+ System.getProperty("port"));
//        System.out.println("UserName--------------------------@@@@@"+ System.getProperty("executionMode"));
//        System.out.println("UserName--------------------------@@@@@"+ System.getProperty("browser"));
